	lab71_soc u0 (
		.blitter_addrx                  (<connected-to-blitter_addrx>),                  //                 blitter.addrx
		.blitter_addry                  (<connected-to-blitter_addry>),                  //                        .addry
		.blitter_sram_addr              (<connected-to-blitter_sram_addr>),              //                        .sram_addr
		.blitter_coloridxin             (<connected-to-blitter_coloridxin>),             //                        .coloridxin
		.blitter_we                     (<connected-to-blitter_we>),                     //                        .we
		.blitter_frame_done             (<connected-to-blitter_frame_done>),             //                        .frame_done
		...
		.run_external_connection_export (<connected-to-run_external_connection_export>), // run_external_connection.export
